...
<body style="background:url(${ctxPath }/static/images/topbg.gif) repeat-x;">
    ...
    <div class="topright">    
    <ul>
    <li><span><img src="${ctxPath }/static/images/help.png" title="帮助"  class="helpimg"/></span><a href="#">帮助</a></li>
    <li><a href="#">关于</a></li>
    <li><a href="${ctxPath }/login.jsp" target="_parent">退出</a></li>
    </ul>
     
    <div class="user">
    <span>${resMsg.data.userName }</span>
    <i>消息</i>
    <b>5</b>
    </div>    
